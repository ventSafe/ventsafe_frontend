...
function CounsellorLoginContent() {
  ...
  useEffect(() => {
    // Check if counsellor is recognized on this device
    const storedEncryptedKey = localStorage.getItem("ventsafe-counsellor-encrypted-key");
    const storedPublicKey = localStorage.getItem("ventsafe-counsellor-public-key");
    const storedName = localStorage.getItem("ventsafe-counsellor-anon-name");
    ...
    if (storedEncryptedKey && storedPublicKey) {
      ...
      setRecognizedName(storedName || "Counsellor");
    }
  }, []);
      ...
      if (isRecognized) {
        ...
        try {
          ...
          if (rememberMe) {
            ...
            localStorage.setItem("ventsafe-counsellor-public-key", pubKeyToUse);
          }
        } catch {
        ...
        <div className="w-full max-w-md">
          ...
          >
            <h1 className="text-4xl font-bold text-ventsafe-foreground mb-3">
              {isRecognized ? "Counsellor Login" : "Counsellor Login"}
            </h1>
